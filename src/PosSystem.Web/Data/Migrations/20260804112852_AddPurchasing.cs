        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PurchaseNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    ...
                    ConfirmedByName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_WarehouseId_Status",
                table: "PurchaseOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceipts_CreatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suppliers_PhoneNormalized",
                table: "Suppliers",
